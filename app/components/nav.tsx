...
const navItems = {
  '/': { name: '', icon: <FaStarOfLife /> },
  '/work': { name: '', icon: <FaBriefcase /> },
  '/blog': { name: '', icon: <FaBook /> },
};
  ...
  return (
    <aside className="-ml-[8px] mb-16 tracking-tight">
      <div className="lg:sticky lg:top-20">
        <nav
          className="flex flex-rows items-start justify-between relative px-0 pb-0 fade md:overflow-auto scroll-pr-6 md:relative"
          id="nav"
        >
          <div className="flex flex-rows font-medium pr-10">
